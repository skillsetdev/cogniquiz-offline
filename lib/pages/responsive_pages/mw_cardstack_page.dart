...
import 'package:cogniquiz_offline/pages/responsive_pages/mw_card_practice_page.dart';
    ...
    return PopScope(
      ...
      child: Consumer(
        builder: (context, value, child) => Scaffold(
          appBar: AppBar(
            foregroundColor: !isDarkMode(context) ? const Color.fromARGB(255, 7, 12, 59) : Color.fromARGB(255, 227, 230, 255),
            ...
            child: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      margin: EdgeInsets.fromLTRB(
                          max(screenWidth / 2 - 400, screenWidth * 0.05), screenHeight * 0.025, max(screenWidth / 2 - 400, screenWidth * 0.05), 0),
                  ...
                  Padding(
                    padding: EdgeInsets.only(left: max(screenWidth / 2 - 400, screenWidth * 0.05)),
                    child: Text("Cards:",
                        style: TextStyle(
                          fontSize: 15.5,
                          color: !isDarkMode(context) ? const Color.fromARGB(255, 7, 12, 59) : Color.fromARGB(255, 227, 230, 255),
                      ...
                      child: ReorderableListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (reordering) {
                            return Container(
                              key: Key('$index'),
                              margin: EdgeInsets.fromLTRB(max(screenWidth / 2 - 400, screenWidth * 0.05), screenHeight * 0.025,
                                  max(screenWidth / 2 - 400, screenWidth * 0.05), 0),
                              decoration: BoxDecoration(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: GestureDetector(
                                              onTap: () {
                                                appData.startNamingQuizQuestion(pageCardStack, index);
                                              },
                                              child: Icon(
