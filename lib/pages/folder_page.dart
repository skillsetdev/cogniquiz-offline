...
//Next Task: finish editing and deleting capabilities
//empty commit
...
import 'package:cogniquiz_offline/pages/subfolder_page.dart';
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                            ...
                            child: ReorderableListView.builder(
                              proxyDecorator: (widget, index, animation) {
                                return AnimatedBuilder(
                                    ...
                                    child: Container(
                                      margin: EdgeInsets.fromLTRB(screenWidth * 0.05, screenHeight * 0.025, 0, 0),
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        Row(
                                          children: [
                                            ...
                                            Spacer(),
                                            Text(pageFolder.subfolders[index].name, style: TextStyle(fontSize: 15, fontWeight: FontWeight.w600)),
                                            Spacer(),
                                            IconButton(
                                              onPressed: () {},
                                ...
                                if (!editing) {
                                  return Dismissible(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        Visibility(
                                          visible: pageFolder.subfolders[index].renamingFolder,
                                          child: Row(
                                            children: [
                                              SizedBox(width: screenWidth * 0.08),
                                              Visibility(
                                        ...
                                        Visibility(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Spacer(),
                                              Text(pageFolder.subfolders[index].name,
                                                  style: TextStyle(
                                                      fontSize: 15,
                                              ...
                                              IconButton(
                                                onPressed: () {
                                                  Navigator.push(
                                                      context,
                                                      MaterialPageRoute(
                                                          builder: (context) => SubfolderPage(selectedFolder: pageFolder.subfolders[index])));
                                                },
                                                icon: Icon(Icons.arrow_forward_ios,
                                                    color: !isDarkMode(context)
                                                        ? const Color.fromARGB(255, 7, 12, 59)
                    ...
                    Visibility(
                      visible: screenWidth > screenHeight * 1.5,
                      child: Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          Visibility(
                                  ...
                                  if (!editing) {
                                    return Dismissible(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                          Visibility(
                                            visible: !pageFolder.cardstacks[index].renamingCardStack,
                                            child: Row(
                                              children: [
                                                SizedBox(width: screenWidth * 0.08),
                                                Icon(Icons.quiz_outlined,
                                                    color: !isDarkMode(context)
                                                        ...
                                                        : Color.fromARGB(255, 227, 230, 255)),
                                                Spacer(),
                                                Text(pageFolder.cardstacks[index].name,
                                                    style: TextStyle(
                                                        fontSize: 15,
                                                        fontWeight: FontWeight.w600,
                                                        color: !isDarkMode(context)
                                              ...
                                              child: Row(
                                                children: [
                                                  ...
                                                  IconButton(
                                                    ...
                                                    icon: Icon(Icons.done,
                                                        color:
                                                            pageFolder.cardstacks[index].name != "" ? Color.fromARGB(255, 4, 228, 86) : Colors.grey),
                                                  ),
                                                  SizedBox(width: screenWidth * 0.08),
                                                ],
                                              ))
